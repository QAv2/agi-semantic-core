...
COMPETENCE_STOPLIST = {'light', 'parked', 'wetness', 'still', 'blinding', 'blindingly', 'small', 'fast', 'silent', 'largest', 'size', 'loud', 'moonless', 'temperature', 'slow', 'silence', 'dark', 'smallest', 'hot', 'dry', 'huge', 'whisper', 'freezing', 'bright', 'deafening', 'boiling', 'tiny', 'big', 'cold', 'speed', 'wet', 'soaked', 'loudness', 'large', 'quiet', 'brightness'}
