...
- source_sentence: cat
  ...
  - snort
  - vomit
- source_sentence: lean
  sentences:
  - sorry
  - rate
  - rich
- source_sentence: open
  sentences:
  - order
  - naught
  - shut
...
print(similarities)
# tensor([[ 1.0000, -0.0046,  0.4682],
#         [-0.0046,  1.0000,  0.4980],
#         [ 0.4682,  0.4980,  1.0000]])
```
<!--
...
* Approximate statistics based on the first 100 samples:
  ...
  | modality | text                                                                              | text                                                                              |                                                                |
  | details  | <ul><li>min: 3 tokens</li><li>mean: 11.12 tokens</li><li>max: 36 tokens</li></ul> | <ul><li>min: 3 tokens</li><li>mean: 10.59 tokens</li><li>max: 36 tokens</li></ul> | <ul><li>min: 0.0</li><li>mean: 0.64</li><li>max: 1.0</li></ul> |
* Samples:
  | sentence1                                                 | sentence2                                                     | score                           |
  |:----------------------------------------------------------|:--------------------------------------------------------------|:--------------------------------|
  | <code>ERODE: Gradual wearing away by wind or water</code> | <code>WITHER: Gradually losing life force, drying up</code>   | <code>0.9753889067108936</code> |
  | <code>VIVID: Intensely bright, strikingly clear</code>    | <code>BRIGHT: Emitting or reflecting much light, clear</code> | <code>0.9893135974225867</code> |
  | <code>exultant</code>                                     | <code>rejoicing</code>                                        | <code>0.9</code>                |
